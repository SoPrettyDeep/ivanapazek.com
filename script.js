...
loginBtn.addEventListener("click", function() {
  ...
  fetch("https://bpazek.000webhostapp.com/login.php", {    //Note that we need to replace https://yourdomain.com with the actual domain name or IP address of your 000webhost server.
    method: "POST",
    headers: {
